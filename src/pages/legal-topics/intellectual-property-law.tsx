...
const IntellectualPropertyLaw: React.FC = () => {
  ...
  const handleDownload = () => {
    const filePath = '/pdfs/code4.pdf';
    
    const link = document.createElement('a');
    link.href = filePath;
    link.download = 'قانون_الملكية_الفكرية_الأردني.pdf';
      ...
      <main className="container mx-auto px-4 py-8 relative" dir="rtl">
        ...
        <section className={`${darkMode ? 'bg-gray-800' : 'bg-white'} p-8 rounded-lg shadow-md mb-8`}>
          ...
          <p className={`${darkMode ? 'text-gray-300' : 'text-gray-700'} mb-4 leading-relaxed`}>
            يهدف قانون الملكية الفكرية في الأردن إلى حماية حقوق المبدعين والمخترعين وأصحاب العلامات التجارية. يغطي هذا القانون مجالات متعددة من الملكية الفكرية، بما في ذلك حقوق المؤلف، براءات الاختراع، والعلامات التجارية.
          </p>
        </section>
        ...
        <section className={`${darkMode ? 'bg-gray-800' : 'bg-white'} p-8 rounded-lg shadow-md mb-8`}>
          ...
          <ul className={`list-disc list-inside space-y-2 ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
            <li>حماية حقوق المؤلف والحقوق المجاورة</li>
            <li>تسجيل وحماية براءات الاختراع</li>
            <li>تسجيل وحماية العلامات التجارية</li>
            <li>حماية الأسرار التجارية</li>
            <li>إجراءات التقاضي في قضايا الملكية الفكرية</li>
          </ul>
        </section>
