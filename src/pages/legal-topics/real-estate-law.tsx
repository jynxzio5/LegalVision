...
const RealEstateLaw: React.FC = () => {
  ...
  const handleDownload = () => {
    const filePath = '/pdfs/code2.pdf';
    
    const link = document.createElement('a');
    link.href = filePath;
    link.download = 'قانون_الملكية_العقارية_الأردني.pdf';
  ...
  return (
    <div className={`min-h-screen font-tajawal ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-black'}`}>
      ...
      <main className="container mx-auto px-4 py-8 relative" dir="rtl">
        ...
        <h1 className={`text-4xl font-bold mb-8 text-center ${darkMode ? 'text-white' : 'text-gray-900'}`}>قانون الملكية العقارية في الأردن</h1>
        ...
        <section className={`${darkMode ? 'bg-gray-800' : 'bg-white'} p-8 rounded-lg shadow-md mb-8`}>
          ...
          <p className={`${darkMode ? 'text-gray-300' : 'text-gray-700'} mb-4 leading-relaxed`}>
            يعتبر قانون الملكية العقارية في الأردن من القوانين الهامة التي تنظم حقوق الملكية والتصرفات العقارية. يهدف هذا القانون إلى ضمان حقوق الملكية وتنظيم عمليات البيع والشراء والإيجار للعقارات في المملكة.
          </p>
        </section>
        ...
        <section className={`${darkMode ? 'bg-gray-800' : 'bg-white'} p-8 rounded-lg shadow-md mb-8`}>
          ...
          <ul className={`list-disc list-inside space-y-2 ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
            <li>تعريف الملكية العقارية وأنواعها</li>
            <li>إجراءات تسجيل العقارات</li>
            <li>حقوق وواجبات المالكين والمستأجرين</li>
            <li>القيود على الملكية العقارية</li>
            <li>الرهن العقاري وأحكامه</li>
          </ul>
        </section>
        ...
        <section className={`${darkMode ? 'bg-gray-800' : 'bg-white'} p-8 rounded-lg shadow-md mb-8`}>
          ...
          <p className={`${darkMode ? 'text-gray-300' : 'text-gray-700'} mb-4 leading-relaxed`}>
            يلعب قانون الملكية العقارية دورًا حيويًا في تنظيم السوق العقاري وحماية حقوق الأفراد والمؤسسات. كما يساهم في:
          </p>
          <ul className={`list-disc list-inside space-y-2 ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
            <li>تعزيز الاستثمار في القطاع العقاري</li>
            <li>حل النزاعات المتعلقة بالملكية العقارية</li>
            <li>تنظيم عمليات التخطيط العمراني</li>
            <li>حماية الحقوق العقارية للمواطنين والأجانب</li>
          </ul>
        </section>
