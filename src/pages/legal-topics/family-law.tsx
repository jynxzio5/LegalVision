  ...
  return (
    <div className={`min-h-screen font-tajawal ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-gray-900'}`}>
      ...
      <main className="container mx-auto px-4 py-8 relative" dir="rtl">
        ...
        <h1 className={`text-4xl font-bold mb-6 text-center ${darkMode ? 'text-white' : 'text-gray-900'} text-shadow`}>قانون الأسرة في الأردن</h1>
        ...
        <div className="text-center mt-8">
          <a 
            ...
            download="قانون_الأسرة_الأردني.pdf"
          >
