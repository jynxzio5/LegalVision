...
const ElectronicTransactionsLaw: React.FC = () => {
  ...
  const handleDownload = () => {
    const filePath = '/pdfs/code1.pdf';
    
    const link = document.createElement('a');
    link.href = filePath;
    link.download = 'قانون_المعاملات_الإلكترونية_الأردني.pdf';
  ...
  return (
    <div className={`min-h-screen font-tajawal ${darkMode ? 'bg-gray-900 text-white' : 'bg-gray-50 text-black'}`}>
      ...
      <main className="container mx-auto px-4 py-8 relative" dir="rtl">
        ...
        <h1 className={`text-4xl font-bold mb-8 text-center ${darkMode ? 'text-white' : 'text-gray-900'}`}>قانون المعاملات الإلكترونية في الأردن</h1>
        ...
        <section className={`${darkMode ? 'bg-gray-800' : 'bg-white'} p-8 rounded-lg shadow-md mb-8`}>
          ...
          <p className={`${darkMode ? 'text-gray-300' : 'text-gray-700'} mb-4 leading-relaxed`}>
            يهدف قانون المعاملات الإلكترونية في الأردن إلى تنظيم المعاملات الإلكترونية وتوفير الإطار القانوني للتجارة الإلكترونية والتوقيعات الإلكترونية. يسعى هذا القانون إلى تعزيز الثقة في المعاملات الإلكترونية وتشجيع نمو الاقتصاد الرقمي في المملكة.
          </p>
        </section>
        ...
        <section className={`${darkMode ? 'bg-gray-800' : 'bg-white'} p-8 rounded-lg shadow-md mb-8`}>
          ...
          <ul className={`list-disc list-inside space-y-2 ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
            <li>تعريف المعاملات الإلكترونية والسجلات الإلكترونية</li>
            <li>الاعتراف القانوني بالتوقيعات الإلكترونية</li>
            <li>حماية المستهلك في التجارة الإلكترونية</li>
            <li>تنظيم خدمات التصديق الإلكتروني</li>
            <li>الجرائم الإلكترونية والعقوبات المرتبطة بها</li>
          </ul>
        </section>

        <section className={`${darkMode ? 'bg-gray-800' : 'bg-white'} p-8 rounded-lg shadow-md mb-8`}>
          <h2 className={`text-2xl font-semibold mb-6 ${darkMode ? 'text-white' : 'text-gray-900'}`}>أهمية القانون</h2>
          <p className={`${darkMode ? 'text-gray-300' : 'text-gray-700'} mb-4 leading-relaxed`}>
            يلعب قانون المعاملات الإلكترونية دورًا حيويًا في تعزيز الثقة في البيئة الرقمية وتشجيع الابتكار في مجال التكنولوجيا. كما يساهم في:
          </p>
          <ul className={`list-disc list-inside space-y-2 ${darkMode ? 'text-gray-300' : 'text-gray-700'}`}>
            <li>تسهيل التجارة الإلكترونية وزيادة فرص الأعمال</li>
            <li>حماية حقوق المستهلكين في المعاملات الإلكترونية</li>
            <li>تعزيز الأمن السيبراني وحماية البيانات الشخصية</li>
            <li>دعم التحول الرقمي في القطاعين العام والخاص</li>
          </ul>
        </section>
...
export default ElectronicTransactionsLaw;
