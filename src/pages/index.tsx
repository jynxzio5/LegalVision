...
import { Book, Bookmark, HelpCircle, Scale } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen bg-gray-50">
          ...
          <div className="flex items-center justify-between">
            ...
            <nav>
              <ul className="flex space-x-reverse space-x-4">
                {/* تم إزالة العناصر المحددة من شريط التنقل العلوي */}
              </ul>
            </nav>
          </div>
        </div>
      ...
      <main className="container mx-auto px-4 py-8">
        <h1 className="text-4xl font-bold mb-8 text-center">رؤيا قانونية</h1>
        
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
          <Link href="/legal-codes" className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
            <Scale size={48} className="mb-4 mx-auto text-blue-600" />
            <h2 className="text-2xl font-semibold mb-2 text-center">القوانين الأردنية</h2>
            <p className="text-gray-600 text-center">استعرض القوانين والتشريعات الأردنية الحديثة</p>
          </Link>
          ...
          <Link href="/course-books" className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
            ...
            <p className="text-gray-600 text-center">اطلع على الكتب الدراسية والمراجع القانونية الهامة</p>
          </Link>
          ...
          <Link href="/question-bank" className="bg-white p-6 rounded-lg shadow-md hover:shadow-lg transition-shadow">
            <HelpCircle size={48} className="mb-4 mx-auto text-blue-600" />
            <h2 className="text-2xl font-semibold mb-2 text-center">بنك الأسئلة</h2>
            <p className="text-gray-600 text-center">اختبر معرفتك القانونية مع مجموعة متنوعة من الأسئلة</p>
          </Link>
        </div>
